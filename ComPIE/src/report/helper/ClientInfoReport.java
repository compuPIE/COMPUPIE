...
public class ClientInfoReport extends BaseReport {
	...
	public Document generateLongClientInfo(int clientID, Document doc) throws DocumentException {
		...
		client.add(new Chunk("" + bean.getClientid(), font2));
		...
		client = new Phrase();
		client.add(new Chunk("Assess on:", font1));
		client.add(new Chunk("" + bean.getDate(), font2));
		...
		client.add(new Chunk("" + info.getDob(), font2));
		...
		client = new Phrase();
		client.add(new Chunk("No. of Children under care: ", font1));
