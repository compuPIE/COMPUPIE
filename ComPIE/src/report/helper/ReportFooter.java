...
public class ReportFooter extends PdfPageEventHelper {
	...
	public ReportFooter() {
		...
		PdfPCell cell1 = new PdfPCell(
				new Paragraph("Produced by CompuPIE Software, Copyright (c) 1998-2007, M. O'Keefe", font2));
	...
	public void onEndPage(PdfWriter writer, Document document) {
		PdfPCell cell1 = new PdfPCell(
				new Paragraph("Page " + writer.getCurrentPageNumber() + " of " + writer.getPageNumber(), font1));
		cell1.setNoWrap(true);
