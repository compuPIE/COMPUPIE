	...
	public Menu(Home home, Rectangle rectangle) {
		...
		groupLayout
				.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(
								groupLayout.createSequentialGroup().addGap(60)
										.addComponent(lblNewLabel_3, GroupLayout.PREFERRED_SIZE, 138,
										...
										.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
												...
												.addGroup(groupLayout.createSequentialGroup().addGap(69)
														...
														.addGap(71)))
										.addGap(260))
						.addGroup(groupLayout.createSequentialGroup().addGap(397)
								.addComponent(lblMenu, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)
								.addGap(405))
						.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup().addGap(47)
								.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
										.addComponent(txtrCompupieIsAn, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
												741, Short.MAX_VALUE)
										.addGroup(groupLayout.createSequentialGroup()
												.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
														.addComponent(btnDedication, GroupLayout.DEFAULT_SIZE, 197,
																Short.MAX_VALUE)
														.addComponent(btnNewButton, GroupLayout.DEFAULT_SIZE, 197,
																Short.MAX_VALUE))
												.addGap(77)
												.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
														.addGroup(groupLayout.createSequentialGroup()
																.addComponent(button_3, GroupLayout.DEFAULT_SIZE, 197,
																		Short.MAX_VALUE)
																.addGap(74).addComponent(button_4,
																		GroupLayout.DEFAULT_SIZE, 196, Short.MAX_VALUE))
														.addGroup(groupLayout.createSequentialGroup()
																.addComponent(btnNewButton_1, GroupLayout.DEFAULT_SIZE,
																		197, Short.MAX_VALUE)
																.addGap(74).addComponent(btnHistoryOfPie,
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup().addGap(13).addComponent(lblNewLabel).addGap(18)
								.addComponent(lblNewLabel_1).addGap(18).addComponent(lblNewLabel_2)))
				.addGap(18).addComponent(txtrCompupieIsAn, GroupLayout.PREFERRED_SIZE, 117, GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.RELATED)
				.addComponent(lblMenu, GroupLayout.PREFERRED_SIZE, 39, GroupLayout.PREFERRED_SIZE).addGap(32)
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addGroup(groupLayout.createSequentialGroup().addGap(2).addComponent(button_3,
